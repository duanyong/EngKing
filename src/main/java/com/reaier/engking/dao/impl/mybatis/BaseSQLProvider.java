...
import com.reaier.engking.dao.complexQuery.CustomQueryParam;
import com.reaier.engking.dao.complexQuery.NoValueQueryParam;
import com.reaier.engking.dao.complexQuery.Sort;
import com.reaier.engking.dao.complexQuery.WithValueQueryParam;
import com.reaier.engking.dao.impl.mybatis.modelParser.ColumnTarget;
import com.reaier.engking.dao.impl.mybatis.modelParser.ModelUtils;
import com.reaier.engking.dao.impl.mybatis.modelParser.Property;
import com.reaier.engking.dao.model.Entity;
import com.reaier.engking.dao.model.EntityWithTime;
import com.reaier.util.ReflectUtils;
...
public class BaseSQLProvider<T extends Entity> {
    ...
    public String getAll() {
        ...
        return SELECT_FROM().toString();
    }

    public String getById() {
        initFromThreadLocal();

        return SELECT_FROM().WHERE(parseIdColumn() + " = #{id}").toString();
    }

    public String getCount(Map<String, Object> dataMap) {
        initFromThreadLocal();

        return WHERE(COUNT_FROM(), (T) dataMap.get("findParams"), OPERATOR_EQUAL).toString();
    }

    public String get(Map<String, Object> dataMap) {
        initFromThreadLocal();

        return WHERE(SELECT_FROM(), (T) dataMap.get("findParams"), OPERATOR_EQUAL).toString();
    }
    ...
    public String countFind(Map<String, Object> dataMap) {
        ...
        return WHERE(COUNT_FROM(), findParams, OPERATOR_LIKE).toString();
    }
    ...
    public String countQuery(Map<String, Object> customQueryParams) {
        ...
        return WHERE_CUSTOM(COUNT_FROM(), customQueryParams).toString();
    }
